...
int main()
{
    ...
    int count = read_file(input, daily_readings,0);

    float mean = find_mean(daily_readings,count);

    float lowest = find_lowest(daily_readings, count);

    float highest = find_highest(daily_readings, count);
    ...
    while (1)
    {
        ...
        case 'C':
        case 'c':
            printf("The lowest reading is %g\n",lowest);
            
            break;

        case 'D':
        case 'd':
            printf("The highest reading is %g\n",highest);
            break;
