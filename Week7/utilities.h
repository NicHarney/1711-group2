...
{
    // to do
    float highest_reading = dataArray[0].bloodIron;
    int i = 0;

    for(i = 0; i < numReadings; i++){

        if (dataArray[i].bloodIron > highest_reading){
            highest_reading = dataArray[i].bloodIron;
        }
    }
...
{
    // to do
    float lowest_reading = dataArray[0].bloodIron;
    int i = 0;

    for(i = 0; i < numReadings; i++){

        if (dataArray[i].bloodIron < lowest_reading){
            lowest_reading = dataArray[i].bloodIron;
        }
    }
